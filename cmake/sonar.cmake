find_file(VERAPP NAMES vera++.exe)
...
if (${VERAPP} MATCHES VERAPP-NOTFOUND)
	...
	add_custom_target(verastyle  vera++.exe ${VERARULES}  -c ${PROJECT_SOURCE_DIR}/sonar/vera++-report.xml --warning ${verasrcs})
	#message("${VERAPP}  -x ${PROJECT_SOURCE_DIR}/vera++-report.xml --warning ${verasrcs_STR}")
endif(${VERAPP} MATCHES VERAPP-NOTFOUND)


find_file(CPPCHECK NAMES cppcheck.exe)
...
if (${CPPCHECK} MATCHES CPPCHECK-NOTFOUND)
	...
	if( RAPIDJSON_FOUND AND USE_RAPIDJSON)
	...
	SET ( CPPC_INC -I${PROJECT_SOURCE_DIR}/include -I${PROJECT_SOURCE_DIR}/inl -I${PROJECT_SOURCE_DIR}/src/db/private)
	...
	add_custom_target(cppcheck COMMAND ${PROJECT_SOURCE_DIR}/cppcheckscript.bat ${CPPCHK_FILE} "${PROJECT_SOURCE_DIR}/src" "${CPPC_INC}" )
